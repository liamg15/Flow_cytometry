...
```{r Gating strategy}
g.cells <- polygonGate(filterId = "Cells","FSC.A"=c(6e4,27e4,27e4,12e4),"SSC.A"=c(0e4,0e4,27e4,27e4)) # define gate
...
ps %>% mutate(percent_of_parent=round(100*Count/ParentCount,digits = 2)) %>% 
  knitr::kable()
```
